...
public abstract class LocalGame implements Game{
	...
	private LinkedBlockingQueue<GameAction> queue;
	 ...
	 */
	private void receiveMessage(GameAction action) {
	...
	/**
	 * thread for processing actions sent from players
	 * @author Qi Liang
	 *
	 */
		...
		public void run(){
			while(true){
				try {
					...
					Log.i("LocalGame", "interrupted while handling actions");
				}
			}
		}
	}
